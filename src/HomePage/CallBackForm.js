      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-6 col-lg-5 col-xl-4">
            ...
            <p className="text-muted" style={{ color: 'white' }}>Monday to Friday, 9am-5pm.</p>
          </div>
          <div className="col-md-6 col-lg-5 col-xl-4">
            <form className="row" id="contactForm" onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                />
                {nameError && <div id="nameError" className="invalid-feedback" style={{ display: 'block' }}>Please enter your name.</div>}
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                />
                {emailError && <div id="emailError" className="invalid-feedback" style={{ display: 'block' }}>Please enter a valid email address.</div>}
              </div>
              <div className="mb-5">
                ...
                <textarea
                  ...
                  required
                />
                {messageError && <div id="messageError" className="invalid-feedback" style={{ display: 'block' }}>Please enter a message.</div>}
              </div>
              <div className="d-grid">
                <button className="btn btn-primary" style={{ backgroundColor: '#3282B8', borderColor: '#3282B8' }} type="submit">
