        ...
        <div className="bg-holder bg-size" style={{ backgroundColor: '#1B262C', height: '100%' }}>
          <div className="container p-4" style={{ width: '100%', backgroundColor: '#1B262C' }}>
            <div className="row">
              ...
              <div className="col-md-6">
                <h1 id="headertext" className="text-center" style={{ color: 'white' }}>Sign Up</h1>
                <form>
                  <p id="text" style={{ color: 'white' }}>Email</p>
                  <div className="input-group mb-3">
                    <input type="text" className="form-control" placeholder="Username" style={{ color: 'white', border: 'none' }} />
                  </div>
                  ...
                  <div className="input-group mb-3">
                    ...
                    <div className="input-group-append">
                      <span
                        ...
                        style={{ backgroundColor: '#0F4C75', border: 'none', borderRadius: '0px 5px 5px 0px', height: '38px' }}
                  ...
                  <p id="text" style={{ color: 'white' }}>Confirm Password</p>
                  <div className="input-group mb-3">
                    <input
